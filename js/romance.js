...
shopping_cart_441.addEventListener("click", ()=>{
    produtos_sidebar.push({
        img: `src="imagens dos livros/categoria romance/A canção de Aquiles - Madeline Miller.jfif" class="a-anuncio-1" style="margin-left: -20px; width: 70.5px; height: 110px;"`,
        preco: 34.99
    })
    listarLivros();
    atualizarTotal();
...
shopping_cart_442.addEventListener("click", ()=>{
    produtos_sidebar.push({
        img: `src="imagens dos livros/categoria romance/A culpa é das estrelas - John green.jpg" class="a-anuncio-1" style="margin-left: -20px; width: 70.5px; height: 110px;"`,
        preco: 79.99
    })
    listarLivros();
    atualizarTotal();
...
shopping_cart_443.addEventListener("click", ()=>{
    produtos_sidebar.push({
        img: 'src="imagens dos livros/categoria romance/Aristóteles e Dante descobrem os segredos do universo - Benjamin Alire.jpg" class="a-anuncio-1" style="margin-left: -20px; width: 70.5px; height: 110px;"',
        preco: 29.99,
    })
    listarLivros();
    atualizarTotal();
...
shopping_cart_444.addEventListener("click", ()=>{
    produtos_sidebar.push({
        img: 'src="imagens dos livros/categoria romance/Como eu era antes de você livro - Jojo Moyes.jpg" class="a-anuncio-1" style="margin-left: -20px; width: 70.5px; height: 110px;"',
        preco: 19.99,
    })
    listarLivros();
    atualizarTotal();
...
shopping_cart_445.addEventListener("click", ()=>{
    produtos_sidebar.push({
        img: 'src="imagens dos livros/categoria romance/Crepúsculo - Nicola Barbola.jpg" class="a-anuncio-1" style="margin-left: -20px; width: 70.5px; height: 110px;"',
        preco: 41.99,
    })
    listarLivros();
    atualizarTotal();
...
shopping_cart_446.addEventListener("click", ()=>{
    produtos_sidebar.push({
        img: 'src="imagens dos livros/categoria romance/Dom Casmurro - Machado de Assis.jpg" class="a-anuncio-1" style="margin-left: -20px; width: 70.5px; height: 110px;"',
        preco: 27.99,
    })
    listarLivros();
    atualizarTotal();
...
shopping_cart_447.addEventListener("click", ()=>{
    produtos_sidebar.push({
        img: 'src="imagens dos livros/categoria romance/é assim que acaba - colleen hoover.jpg" class="a-anuncio-1" style="margin-left: -20px; width: 70.5px; height: 110px;"',
        preco: 31.99,
    })
    listarLivros();
    atualizarTotal();
...
shopping_cart_448.addEventListener("click", ()=>{
    produtos_sidebar.push({
        img: 'src="imagens dos livros/categoria romance/Garota exemplar -Gillian Flynn.jpg" class="a-anuncio-1" style="margin-left: -20px; width: 70.5px; height: 110px;"',
        preco: 38.99,
    })
    listarLivros();
    atualizarTotal();
...
shopping_cart_449.addEventListener("click", ()=>{
    produtos_sidebar.push({
        img: 'src="imagens dos livros/categoria romance/Intermitências da morte - José Saramago.jpg" class="a-anuncio-1" style="margin-left: -20px; width: 70.5px; height: 110px;"',
        preco: 56.99,
    })
    listarLivros();
    atualizarTotal();
...
shopping_cart_450.addEventListener("click", ()=>{
    produtos_sidebar.push({
        img: 'src="imagens dos livros/categoria romance/Madame Bovary - Gustofe flauver.jfif" class="a-anuncio-1" style="margin-left: -20px; width: 70.5px; height: 110px;"',
        preco: 18.99,
    })
    listarLivros();
    atualizarTotal();
...
shopping_cart_451.addEventListener("click", ()=>{
    produtos_sidebar.push({
        img: 'src="imagens dos livros/categoria romance/O amor nos tempos do cólera Gabriel - Gárcia Márquez.png" class="a-anuncio-1" style="margin-left: -20px; width: 70.5px; height: 110px;"',
        preco: 29.99,
    })
    listarLivros();
    atualizarTotal();
...
shopping_cart_452.addEventListener("click", ()=>{
    produtos_sidebar.push({
        img: 'src="imagens dos livros/categoria romance/O grande gatsby -  F. Scott Fitzgerald.jfif" class="a-anuncio-1" style="margin-left: -20px; width: 70.5px; height: 110px;"',
        preco: 49.99,
    })
    listarLivros();
    atualizarTotal();
...
shopping_cart_453.addEventListener("click", ()=>{
    produtos_sidebar.push({
        img: 'src="imagens dos livros/categoria romance/O morro dos ventos uivantes - Emily Bronte.jpg" class="a-anuncio-1" style="margin-left: -20px; width: 70.5px; height: 110px;"',
        preco: 48.99,
    })
    listarLivros();
    atualizarTotal();
...
shopping_cart_454.addEventListener("click", ()=>{
    produtos_sidebar.push({
        img: 'src="imagens dos livros/categoria romance/Orgulho e Preconceito - Jane Austen.jpg" class="a-anuncio-1" style="margin-left: -20px; width: 70.5px; height: 110px;"',
        preco: 16.99,
    })
    listarLivros();
    atualizarTotal();
...
let fav7 = [
    ...
    id: 441, 
        ...
        img: `src="imagens dos livros/categoria romance/A canção de Aquiles - Madeline Miller.jfif" class="a-anuncio-1" style="width: 137.5px; height: 200px;"`,
        preco: 34.99
    },
    {
        id: 442, 
        ...
        autor:"John Green",
        img: `src="imagens dos livros/categoria romance/A culpa é das estrelas - John green.jpg" class="a-anuncio-1" style="width: 137.5px; height: 200px;"`,
        preco: 79.99
    },
    {
    id: 443, 
        ...
        img: 'src="imagens dos livros/categoria romance/Aristóteles e Dante descobrem os segredos do universo - Benjamin Alire.jpg" class="a-anuncio-1" style="width: 137.5px; height: 200px;"',
        preco: 29.99,
    },
    {
    id: 444, 
        ...
        autor:"Jojo Moyes",
        img: 'src="imagens dos livros/categoria romance/Como eu era antes de você livro - Jojo Moyes.jpg" class="a-anuncio-1" style="width: 137.5px; height: 200px;"',
        preco: 19.99,
    },
    {
    id: 445, 
        ...
        img: 'src="imagens dos livros/categoria romance/Crepúsculo - Nicola Barbola.jpg" class="a-anuncio-1" style="width: 137.5px; height: 200px;"',
        preco: 41.99,
    },
    {
    id: 446, 
        ...
        img: 'src="imagens dos livros/categoria romance/Dom Casmurro - Machado de Assis.jpg" class="a-anuncio-1" style="width: 137.5px; height: 200px;"',
        preco: 27.99,
    },
    {
    id: 447, 
        ...
        autor:"Collen Hover",
        img: 'src="imagens dos livros/categoria romance/é assim que acaba - colleen hoover.jpg" class="a-anuncio-1" style="width: 137.5px; height: 200px;"',
        preco: 31.99,
    },
    {
    id: 448, 
        ...
        autor:"Gillian Flynn",
        img: 'src="imagens dos livros/categoria romance/Garota exemplar -Gillian Flynn.jpg" class="a-anuncio-1" style="width: 137.5px; height: 200px;"',
        preco: 38.99,
    },
    {
    id: 449, 
        ...
        autor:"José Saramago",
        img: 'src="imagens dos livros/categoria romance/Intermitências da morte - José Saramago.jpg" class="a-anuncio-1" style="width: 137.5px; height: 200px;"',
        preco: 56.99,
    },
    {
    id: 450, 
        ...
        img: 'src="imagens dos livros/categoria romance/Madame Bovary - Gustofe flauver.jfif" class="a-anuncio-1" style="width: 137.5px; height: 200px;"',
        preco: 18.99,
    },
    {
    id: 451, 
        ...
        img: 'src="imagens dos livros/categoria romance/O amor nos tempos do cólera Gabriel - Gárcia Márquez.png" class="a-anuncio-1" style="width: 137.5px; height: 200px;"',
        preco: 29.99,
    },
    {
    id: 452, 
        ...
        img: 'src="imagens dos livros/categoria romance/O grande gatsby -  F. Scott Fitzgerald.jfif" class="a-anuncio-1" style="width: 137.5px; height: 200px;"',
        preco: 49.99,
    },
    {
    id: 453, 
        ...
        autor:"Emily Bronte",
        img: 'src="imagens dos livros/categoria romance/O morro dos ventos uivantes - Emily Bronte.jpg" class="a-anuncio-1" style="width: 137.5px; height: 200px;"',
        preco: 48.99,
    },
    {
    id: 454, 
        ...
        autor:"Jane Austen",
        img: 'src="imagens dos livros/categoria romance/Orgulho e Preconceito - Jane Austen.jpg" class="a-anuncio-1" style="width: 137.5px; height: 200px;"',
        preco: 16.99,
    },
]
