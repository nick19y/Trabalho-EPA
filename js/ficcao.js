...
shopping_cart_221.addEventListener("click", ()=>{
    produtos_sidebar.push({
        img: 'src="imagens dos livros/livros ficcao/2001 uma odisseia no espaco - arther c.clarke.jpg" class="a-anuncio-1" style="width: 137.5px;"',
        preco: 34.99,
    })
    listarLivros();
    atualizarTotal();
...
shopping_cart_222.addEventListener("click", ()=>{
    produtos_sidebar.push({
        img: 'src="imagens dos livros/livros ficcao/2084 - james lawrence powell.png" class="a-anuncio-1" style="width: 157.5px; margin-right: 15px; margin-top: 1px;"',
        preco: 79.99,
    })
    listarLivros();
    atualizarTotal();
...
shopping_cart_223.addEventListener("click", ()=>{
    produtos_sidebar.push({
        img: 'src="imagens dos livros/livros ficcao/a batalha do apocalipse - eduardo spohe.png" class="a-anuncio-1" style="width: 195px; margin-top: 3px; margin-bottom: 10px;" ',
        preco: 29.99,
    })
    listarLivros();
    atualizarTotal();
...
shopping_cart_224.addEventListener("click", ()=>{
    produtos_sidebar.push({
        img: 'src="imagens dos livros/livros ficcao/a biblioteca da meia noite - matt haig.jpg" class="a-anuncio-1" style="width: 142.5px;"',
        preco: 19.99,
    })
    listarLivros();
    atualizarTotal();
...
shopping_cart_225.addEventListener("click", ()=>{
    produtos_sidebar.push({
        img: 'src="imagens dos livros/livros ficcao/a telepatia sao os outros - ana rusche.png" class="a-anuncio-1" style="width: 205px; margin-top: 3px;"',
        preco: 41.99,
    })
    listarLivros();
    atualizarTotal();
...
shopping_cart_226.addEventListener("click", ()=>{
    produtos_sidebar.push({
        img: 'src="imagens dos livros/livros ficcao/count zero - willian gibson.png" class="a-anuncio-1" style="width: 205px; margin-top: 3px;"',
        preco: 27.99,
    })
    listarLivros();
    atualizarTotal();
...
shopping_cart_227.addEventListener("click", ()=>{
    produtos_sidebar.push({
        img: 'src="imagens dos livros/livros ficcao/filhos do eden - eduardo spohr.png" class="a-anuncio-1" style="width: 210px;"',
        preco: 31.99,
    })
    listarLivros();
    atualizarTotal();
...
shopping_cart_228.addEventListener("click", ()=>{
    produtos_sidebar.push({
        img: 'src="imagens dos livros/livros ficcao/guerra do velho - john scalzi.jpg" class="a-anuncio-1" style="width: 205px;"',
        preco: 38.99,
    })
    listarLivros();
    atualizarTotal();
...
shopping_cart_229.addEventListener("click", ()=>{
    produtos_sidebar.push({
        img: 'src="imagens dos livros/livros ficcao/metafisica trilogica - norberto r. kepp.png" class="a-anuncio-1" style="width: 220px;"',
        preco: 56.99,
    })
    listarLivros();
    atualizarTotal();
...
shopping_cart_2210.addEventListener("click", ()=>{
    produtos_sidebar.push({
        img: 'src="imagens dos livros/livros ficcao/o homem invisivel - h.g wells.jpg" class="a-anuncio-1"style="width: 277.5px; margin-right: 10px;"',
        preco: 18.99,
    })
    listarLivros();
    atualizarTotal();
...
shopping_cart_2211.addEventListener("click", ()=>{
    produtos_sidebar.push({
        img: 'src="imagens dos livros/livros ficcao/o inferno é aqui - andre schuck.png" class="a-anuncio-1" style="width: 200px;"',
        preco: 29.99,
    })
    listarLivros();
    atualizarTotal();
...
shopping_cart_2212.addEventListener("click", ()=>{
    produtos_sidebar.push({
        img: 'src="imagens dos livros/livros ficcao/o lugar do inicio - ursula k. le guin.png" class="a-anuncio-1" style="width: 200px;"',
        preco: 49.99,
    })
    listarLivros();
    atualizarTotal();
...
shopping_cart_2213.addEventListener("click", ()=>{
    produtos_sidebar.push({
        img: 'src="imagens dos livros/livros ficcao/skiward - brandon sanderson.png" class="a-anuncio-1" style="width: 200px;"',
        preco: 48.99,
    })
    listarLivros();
    atualizarTotal();
...
shopping_cart_2214.addEventListener("click", ()=>{
    produtos_sidebar.push({
        img: 'src="imagens dos livros/livros ficcao/viajantes do abismo - nikelen witter.png" class="a-anuncio-1" style="width: 200px;"',
        preco: 36.99,
    })
    listarLivros();
    atualizarTotal();
...
let fav22 = [
    ...
    id: 2211, 
        ...
        autor:"Andre Schuck",
        img: 'src="imagens dos livros/livros ficcao/o inferno é aqui - andre schuck.png" class="a-anuncio-1" style="width: 200px;"" class="a-anuncio-1"',
        preco: 29.99,
    },
    {
    id: 2212, 
