...
shopping_cart_1.addEventListener("click", ()=>{
    produtos_sidebar.push({
        img: 'src="imagens dos livros/livros brasileiros/o cortico - aluisio azevedo.jpg" alt="" class="img_sidebar" style="margin-left: -20px; width: 70.5px; height: 110px; border: 1px solid white;"',
        preco: 34.99,
    })
    listarLivros();
    atualizarTotal();
...
shopping_cart_2.addEventListener("click", ()=>{
    produtos_sidebar.push({
        img: 'src="img-anuncios/a culpa é das estrelas.png" style="margin-left: -20px; width: 70.5px; height: 110px; border: 1px solid white;"',
        preco: 79.99,
    })
    listarLivros();
    atualizarTotal();
...
shopping_cart_3.addEventListener("click", ()=>{
    produtos_sidebar.push({
        img: 'src="img-anuncios/o morro dos ventos uivantes.png" class="a-anuncio-1" style="margin-left: -20px; width: 70.5px; height: 110px;"',
        preco: 29.99,
    })
    listarLivros();
    atualizarTotal();
...
shopping_cart_4.addEventListener("click", ()=>{
    produtos_sidebar.push({
        img: 'src="img-anuncios/orgulho e preconceito.jpg" class="a-anuncio-1" style="margin-left: -20px; width: 70.5px; height: 110px;"',
        preco: 19.99,
    })
    listarLivros();
    atualizarTotal();
...
shopping_cart_5.addEventListener("click", ()=>{
    produtos_sidebar.push({
        img: 'src="img-anuncios/e assim que acaba.jpg" class="a-anuncio-1" style="margin-left: -20px; width: 70.5px; height: 110px;"',
        preco: 41.99,
    })
    listarLivros();
    atualizarTotal();
...
shopping_cart_6.addEventListener("click", ()=>{
    produtos_sidebar.push({
        img: 'src="img-anuncios/a arte da guerra.jpg" class="a-anuncio-1" style="margin-left: -20px; width: 70.5px; height: 110px;"',
        preco: 27.99,
    })
    listarLivros();
    atualizarTotal();
...
shopping_cart_7.addEventListener("click", ()=>{
    produtos_sidebar.push({
        img: 'src="img-anuncios/o homem de giz.png" class="a-anuncio-1" style="margin-left: -20px; width: 70.5px; height: 110px;"',
        preco: 31.99,
    })
    listarLivros();
    atualizarTotal();
...
shopping_cart_8.addEventListener("click", ()=>{
    produtos_sidebar.push({
        img: 'src="img-anuncios/IT a coisa.jfif" class="a-anuncio-1" style="margin-left: -20px; width: 70.5px; height: 110px;"',
        preco: 38.99,
    })
    listarLivros();
    atualizarTotal();
...
shopping_cart_9.addEventListener("click", ()=>{
    produtos_sidebar.push({
        img: 'src="img-anuncios/o dracula.png" class="a-anuncio-1" style="margin-left: -20px; width: 70.5px; height: 110px;"',
        preco: 56.99,
    })
    listarLivros();
    atualizarTotal();
...
shopping_cart_10.addEventListener("click", ()=>{
    produtos_sidebar.push({
        img: 'src="img-anuncios/os sertoes.png" class="a-anuncio-1" style="margin-left: -20px; width: 70.5px; height: 110px;"',
        preco: 18.99,
    })
    listarLivros();
    atualizarTotal();
...
shopping_cart_11.addEventListener("click", ()=>{
    produtos_sidebar.push({
        img: 'src="img-anuncios/uma odisseia no espaco.png" class="a-anuncio-1" style="margin-left: -20px; width: 70.5px; height: 110px;"',
        preco: 29.99,
    })
    listarLivros();
    atualizarTotal();
...
shopping_cart_12.addEventListener("click", ()=>{
    produtos_sidebar.push({
        img: 'src="img-anuncios/caixa de passaros.png" class="a-anuncio-1" style="margin-left: -20px; width: 70.5px; height: 110px;"',
        preco: 49.99,
    })
    listarLivros();
    atualizarTotal();
...
shopping_cart_15.addEventListener("click", ()=>{
    produtos_sidebar.push({
        img: 'src="img-anuncios/frankenstein.png" class="a-anuncio-1" style="margin-left: -20px; width: 70.5px; height: 110px;"',
        preco: 23.99,
    })
    listarLivros();
    atualizarTotal();
...
shopping_cart_16.addEventListener("click", ()=>{
    produtos_sidebar.push({
        img: 'src="img-anuncios/guerra do velho.png" class="a-anuncio-1" style="margin-left: -20px; width: 70.5px; height: 110px;"',
        preco: 48.99,
    })
    listarLivros();
    atualizarTotal();
...
shopping_cart_17.addEventListener("click", ()=>{
    produtos_sidebar.push({
        img: 'src="img-anuncios/a garota do lago.png" class="a-anuncio-1" style="margin-left: -20px; width: 70.5px; height: 110px;"',
        preco: 26.99,
    })
    listarLivros();
    atualizarTotal();
...
shopping_cart_18.addEventListener("click", ()=>{
    produtos_sidebar.push({
        img: 'src="img-anuncios/a biblioteca da meia noite.png" class="a-anuncio-1" style="margin-left: -20px; width: 70.5px; height: 110px;"',
        preco: 34.99,
    })
    listarLivros();
    atualizarTotal();
...
shopping_cart_19.addEventListener("click", ()=>{
    produtos_sidebar.push({
        img: 'src="img-anuncios/vidas secas.png" class="a-anuncio-1" style="margin-left: -20px; width: 70.5px; height: 110px;"',
        preco: 45.99,
    })
    listarLivros();
    atualizarTotal();
...
shopping_cart_20.addEventListener("click", ()=>{
    produtos_sidebar.push({
        img: 'src="img-anuncios/a cabana da solidao.jpg" class="a-anuncio-1" style="margin-left: -20px; width: 70.5px; height: 110px;"',
        preco: 19.99,
    })
    listarLivros();
    atualizarTotal();
...
shopping_cart_21.addEventListener("click", ()=>{
    produtos_sidebar.push({
        img: 'src="img-anuncios/o poder da manipulação.jpg" class="a-anuncio-1" style="margin-left: -20px; width: 70.5px; height: 110px;"',
        preco: 32.99,
    })
    listarLivros();
    atualizarTotal();
