...
shopping_cart_551.addEventListener("click", ()=>{
    produtos_sidebar.push({
        img: 'src="imagens dos livros/categoria terror/A Assombração da Casa da Colina - Shirley Jackson.jpg" class="a-anuncio-1" style="margin-left: 20px;"',
        preco: 34.99,
    })
    listarLivros();
    atualizarTotal();
...
shopping_cart_552.addEventListener("click", ()=>{
    produtos_sidebar.push({
        img: 'src="imagens dos livros/categoria terror/A coisa IT - Stephen King.jpg" class="a-anuncio-1" style="width: 111px; margin-right: 15px; margin-top: 1px;"',
        preco: 79.99,
    })
    listarLivros();
    atualizarTotal();
...
shopping_cart_553.addEventListener("click", ()=>{
    produtos_sidebar.push({
        img: 'src="imagens dos livros/categoria terror/Bem atras de voce - Lisa Garbner.png" class="a-anuncio-1" style="width: 220px; margin-top: 3px; margin-bottom: 10px;"',
        preco: 29.99,
    })
    listarLivros();
    atualizarTotal();
...
shopping_cart_555.addEventListener("click", ()=>{
    produtos_sidebar.push({
        img: 'src="imagens dos livros/categoria terror/Carmilla - John William.jpg" class="a-anuncio-1" style="width: 175px; margin-top: 3px;"',
        preco: 41.99,
    })
    listarLivros();
    atualizarTotal();
...
shopping_cart_556.addEventListener("click", ()=>{
    produtos_sidebar.push({
        img: 'src="imagens dos livros/categoria terror/Drácula - Bram Stoker.jpg" class="a-anuncio-1" style="width: 170px; margin-top: 3px;"',
        preco: 27.99,
    })
    listarLivros();
    atualizarTotal();
...
shopping_cart_557.addEventListener("click", ()=>{
    produtos_sidebar.push({
        img: 'src="imagens dos livros/categoria terror/Eu estou pensando em acabar com tudo - Iain Reid.jpg" class="a-anuncio-1" style="width: 158px;"',
        preco: 31.99,
    })
    listarLivros();
    atualizarTotal();
...
shopping_cart_558.addEventListener("click", ()=>{
    produtos_sidebar.push({
        img: 'src="imagens dos livros/categoria terror/Frankenstein -  Mary Shelley.jpg" class="a-anuncio-1" style="margin-right: 10px; margin-top: 1px;"',
        preco: 38.99,
    })
    listarLivros();
    atualizarTotal();
...
shopping_cart_5510.addEventListener("click", ()=>{
    produtos_sidebar.push({
        img: 'src="imagens dos livros/categoria terror/O silêncio dos inocentes - Thomas Harries.jpg" class="a-anuncio-1" style="width: 178px; margin-right: 10px;"',
        preco: 18.99,
    })
    listarLivros();
    atualizarTotal();
...
shopping_cart_5511.addEventListener("click", ()=>{
    produtos_sidebar.push({
        img: 'src="imagens dos livros/categoria terror/Os condenados - Andrew Pyper.jpg" class="a-anuncio-1" style="width: 178px;"',
        preco: 29.99,
    })
    listarLivros();
    atualizarTotal();
...
shopping_cart_5512.addEventListener("click", ()=>{
    produtos_sidebar.push({
        img: 'src="imagens dos livros/categoria terror/Strange Case of Dr Jekyll and Mr Hyde - Robert Louis.jpg" class="a-anuncio-1" style="width: 118.5px;"',
        preco: 49.99,
    })
    listarLivros();
    atualizarTotal();
...
let fav5 = [
    ...
    img: `src="imagens dos livros/categoria terror/A Assombração da Casa da Colina - Shirley Jackson.jpg" class="a-anuncio-1"
    ...
    id: 552, 
        nome:"A coisa IT",
        autor:"Stephen King",
        img: `src="imagens dos livros/categoria terror/A coisa IT - Stephen King.jpg" class="a-anuncio-1"
