...
shopping_cart_112.addEventListener("click", ()=>{
    produtos_sidebar.push({
        img: `src="imagens dos livros/livros brasileiros/A paixão segundo G.H., Clarice Lispector.JPG" class="a-anuncio-1" style="margin-left: -20px; width: 70.5px; height: 110px;"`,
        preco: 50.00
    })
    listarLivros();
    atualizarTotal();
...
shopping_cart_115.addEventListener("click", ()=>{
    produtos_sidebar.push({
        img: 'src="imagens dos livros/livros brasileiros/Grande sertão veredas - Guimarães Rosa.jpg" class="a-anuncio-1" style="margin-left: -20px; width: 70.5px; height: 110px;"',
        preco: 41.99,
    })
    listarLivros();
    atualizarTotal();
...
shopping_cart_116.addEventListener("click", ()=>{
    produtos_sidebar.push({
        img: 'src="imagens dos livros/livros brasileiros/Macunaíma , Mário de Andrade.png" class="a-anuncio-1" style="margin-left: -20px; width: 70.5px; height: 110px;"',
        preco: 27.99,
    })
    listarLivros();
    atualizarTotal();
...
shopping_cart_117.addEventListener("click", ()=>{
    produtos_sidebar.push({
        img: 'src="imagens dos livros/livros brasileiros/Memórias sgto de milícias, Manuel A. de Almeida.jpg" class="a-anuncio-1" style="margin-left: -20px; width: 70.5px; height: 110px;"',
        preco: 31.99,
    })
    listarLivros();
    atualizarTotal();
...
shopping_cart_1111.addEventListener("click", ()=>{
    produtos_sidebar.push({
        img: 'src="imagens dos livros/livros brasileiros/São Bernardo, Graciliano Ramos.png" class="a-anuncio-1" style="margin-left: -20px; width: 70.5px; height: 110px;"',
        preco: 29.99,
    })
    listarLivros();
    atualizarTotal();
...
let fav21 = [
    ...
    },
    {
        ...
        autor:"Clarice Lispector",
        img: `src="imagens dos livros/livros brasileiros/A paixão segundo G.H., Clarice Lispector.JPG" class="a-anuncio-1" style="width: 137.5px; height: 200px;"`,
        preco: 50.00
    },
    {
    id: 113, 
        ...
        img: 'src="imagens dos livros/livros brasileiros/Angústia, Graciliano Ramos.jpg" class="a-anuncio-1" style="width: 137.5px; height: 200px;"',
        preco: 29.99,
    },
    {
    id: 114, 
    ...
    id: 115, 
        ...
        img: 'src="imagens dos livros/livros brasileiros/Grande sertão veredas - Guimarães Rosa.jpg" class="a-anuncio-1" style="width: 137.5px; height: 200px;"',
        preco: 41.99,
    },
    {
    id: 116, 
        ...
        img: 'src="imagens dos livros/livros brasileiros/Macunaíma , Mário de Andrade.png" class="a-anuncio-1" style="width: 137.5px; height: 200px;"',
        preco: 27.99,
    },
    {
    id: 117, 
        ...
        img: 'src="imagens dos livros/livros brasileiros/Memórias sgto de milícias, Manuel A. de Almeida.jpg" class="a-anuncio-1" style="width: 137.5px; height: 200px;"',
        preco: 31.99,
    },
    {
    id: 118, 
    ...
    id: 1111, 
        nome:"São Bernardo",
        autor:"Graciliano Ramos",
        img: 'src="imagens dos livros/livros brasileiros/São Bernardo, Graciliano Ramos.png" class="a-anuncio-1" style="width: 137.5px; height: 200px;"',
        preco: 29.99,
    },
    {
    id: 1112, 
