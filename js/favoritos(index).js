...
let fav = [
    ...
    img: `src="img-anuncios/o cortiço.png" class="a-anuncio-1" style="width: 137.5px; height: 200px;"`,
    preco: 50.00
    },
    {
        id: 2, 
        ...
        autor:"John Green",
        img: `src="img-anuncios/a culpa é das estrelas.png" class="a-anuncio-1" style="width: 137.5px; height: 200px;"`,
        preco: 50.00
    },
    {
    id: 3, 
        ...
        autor:"Emily Bronte",
        img: 'src="img-anuncios/o morro dos ventos uivantes.png" class="a-anuncio-1" style="width: 137.5px; height: 200px;"',
        preco: 29.99,
    },
    {
    id: 4, 
        ...
        autor:"Jane Austen",
        img: 'src="img-anuncios/orgulho e preconceito.jpg" class="a-anuncio-1" style="width: 137.5px; height: 200px;"',
        preco: 19.99,
    },
    {
    id: 5, 
        ...
        img: 'src="img-anuncios/e assim que acaba.jpg" class="a-anuncio-1" style="width: 137.5px; height: 200px;"',
        preco: 41.99,
    },
    {
    id: 6, 
        ...
        autor:"Sun Tzu",
        img: 'src="img-anuncios/a arte da guerra.jpg" class="a-anuncio-1" style="width: 137.5px; height: 200px;"',
        preco: 27.99,
    },
    {
    id: 7, 
        nome:"O homem de giz",
        autor:"C.J. Tudor",
        img: 'src="img-anuncios/o homem de giz.png" class="a-anuncio-1" style="width: 137.5px; height: 200px;"',
        preco: 31.99,
    },
    {
    id: 8, 
        nome:"O Iluminado",
        autor:"Stephen King",
        img: 'src="img-anuncios/IT a coisa.jfif" class="a-anuncio-1" style="width: 137.5px; height: 200px;"',
        preco: 38.99,
        preco: 50.00
    },
    {
    id: 9, 
        nome:"O Drácula",
        autor:"Bram Stoker",
        img: 'src="img-anuncios/o dracula.png" class="a-anuncio-1" style="width: 137.5px; height: 200px;"',
        preco: 56.99,
    },
    {
    id: 10, 
        ...
        img: 'src="img-anuncios/os sertoes.png" class="a-anuncio-1" style="width: 137.5px; height: 200px;"',
        preco: 18.99,
    },
    {
    id: 11, 
        ...
        img: 'src="img-anuncios/uma odisseia no espaco.png" class="a-anuncio-1" style="width: 137.5px; height: 200px;"',
        preco: 29.99,
    },
    {
    id: 12, 
        ...
        autor:"Josh Malerman",
        img: 'src="img-anuncios/caixa de passaros.png" class="a-anuncio-1" style="width: 137.5px; height: 200px;"',
        preco: 49.99,
    },
    {
    id: 13, 
        ...
        autor:"J. K. Rowling",
        img: 'src="img-anuncios/harry poter e a camara secreta.png" class="a-anuncio-1" style="width: 137.5px; height: 200px;"',
        preco: 48.99,
    },
    {
    id: 14, 
    ...
    id: 15, 
        nome:"Frankenstein",
        autor:"Mary Shelley",
        img: 'src="img-anuncios/frankenstein.png" class="a-anuncio-1"style="width: 137.5px; height: 200px;"',
        preco: 23.99,
    },
    {
    id: 16, 
        ...
        autor:"John Scalzi",
        img: 'src="img-anuncios/guerra do velho.png" class="a-anuncio-1" style="width: 137.5px; height: 200px;"',
        preco: 48.99,
    },
    {
    id: 17, 
        ...
        img: 'src="img-anuncios/a garota do lago.png" class="a-anuncio-1" style="width: 137.5px; height: 200px;"',
        preco: 26.99,
    },
    {
    id: 18, 
        ...
        autor:"Matt Haig",
        img: 'src="img-anuncios/a biblioteca da meia noite.png" class="a-anuncio-1" style="width: 137.5px; height: 200px;"',
        preco: 34.99,
    },
    {
    id: 19, 
        ...
        img: 'src="img-anuncios/vidas secas.png" class="a-anuncio-1" style="width: 137.5px; height: 200px;"',
        preco: 45.99,
    },
    {
    id: 20, 
        ...
        img: 'src="img-anuncios/a cabana da solidao.jpg" class="a-anuncio-1" style="width: 137.5px; height: 200px;"',
        preco: 19.99,
    },
    {
    id: 21, 
        ...
        autor:"Jacob Petry",
        img: 'src="img-anuncios/o poder da manipulação.jpg" class="a-anuncio-1" style="width: 137.5px; height: 200px;"',
        preco: 32.99,
    },
]
